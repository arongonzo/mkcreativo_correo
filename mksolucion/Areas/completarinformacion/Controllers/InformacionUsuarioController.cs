            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        cnt01_cuenta.cnt01_nombre = values["Empresa"];
                    ...
                    usr01_infopersonal usr01_infopersonal = new usr01_infopersonal();
                    usr01_infopersonal.usr01_nombre = values["Nombre"];
                    usr01_infopersonal.usr01_apellido = values["Apellido"];
                    usr01_infopersonal.UserId = llave_usario;

                    usr01_infopersonal.usr01_direccion1 = values["direccion1"];
                    usr01_infopersonal.usr01_direccion2 = values["direccion2"];

                    usr01_infopersonal.usr01_ciudad = values["Ciudad"];
                    usr01_infopersonal.usr01_codigopostal = values["Zipcode"];
                    usr01_infopersonal.usr01_region = values["Pais"];

                    usr01_infopersonal.usr01_estado = 1;
                    usr01_infopersonal.usr01_fechacreacion = DateTime.Now;
                    usr01_infopersonal.usr01_ultimaactualizacion = DateTime.Now;
                    ...
                    Session["nmbrusr"] = values["Nombre"] + " " + values["Apellido"];
