    ...
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var smtp = new System.Net.Mail.SmtpClient
            {
                Host = "atomos.cl",
                Port = 25,
                Credentials = new System.Net.NetworkCredential("soporte@mailmkcreativo.cl", "lGnh85@6"),
                EnableSsl = true
            };
            ...
            mail.From = new System.Net.Mail.MailAddress("soporte@mailmkcreativo.cl", "Servicio al Cliente Mailcreativo");
